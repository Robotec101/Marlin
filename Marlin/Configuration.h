...
#define STRING_CONFIG_H_AUTHOR "Javier Peña" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 203, 160, 4000, 800 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 20, -1.85 }
